def needed_code():#you can also name it main():
...
print(__name__)#when i am running this program alone program its name is '__main__' 
...
if __name__=='__main__':
    ...
    print("So this if condtion is only true when its the main program, not when its run by a module")
    needed_code()
    print(add(1, 2))