"""
For Input data we use input() casts the entered data as a string known as 'str' data type .
"""
...
#We need to type cast age from 'str' to 'int'
age = int(age)
birth_year = 2025 - age
...
#This does not store the data in a value in the variable, but it works...