#format specifiers = {value:flags, a few format specifiers in Python 
price1= 3.14579626626565622
price2= -65.322500
price3= 12.32
print(f"Price 1 = {price1:.2f}$")#floating point till 2 decimals
print(f"Price 2 = {price2:.3f}$")
print(f"Price 3 = {price3:.10f}$")
print()
#to allocate/generate space for printed values
print(f"Price 1 = {price1:10}")#allocate 10 spaces for the print(including chars) 
